...
var NseIndia = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, axios_1.default.get("".concat(this.baseUrl, "/get-quotes/equity?symbol=TCS"), {
    ...
    NseIndia.prototype.getEquityCorporateInfo = function (symbol) {
        return this.getDataByEndpoint("/api/top-corp-info?symbol=".concat(encodeURIComponent(symbol
    ...
    NseIndia.prototype.getIndexOptionChain = function (indexSymbol) {
        return this.getDataByEndpoint("/api/option-chain-indices?symbol=".concat(encodeURIComponent(indexSymbol
            .toUpperCase())));
    };
    /**
     *
    ...
    NseIndia.prototype.getEquityOptionChain = function (symbol) {
        return this.getDataByEndpoint("/api/option-chain-equities?symbol=".concat(encodeURIComponent(symbol
            .toUpperCase())));
    };
    /**
         *
    ...
    NseIndia.prototype.getCommodityOptionChain = function (symbol) {
        return this.getDataByEndpoint("/api/option-chain-com?symbol=".concat(encodeURIComponent(symbol
            .toUpperCase())));
    };
    /**
     ...
     */
    NseIndia.prototype.getGlossary = function () {
     ...
     */
    NseIndia.prototype.getTradingHolidays = function () {
     ...
     */
    NseIndia.prototype.getClearingHolidays = function () {
     ...
     */
    NseIndia.prototype.getMarketStatus = function () {
     ...
     */
    NseIndia.prototype.getMarketTurnover = function () {
     ...
     */
    NseIndia.prototype.getAllIndices = function () {
     ...
     */
    NseIndia.prototype.getIndexNames = function () {
     ...
     */
    NseIndia.prototype.getCirculars = function () {
     ...
     */
    NseIndia.prototype.getLatestCirculars = function () {
     ...
     */
    NseIndia.prototype.getEquityMaster = function () {
     ...
     */
    NseIndia.prototype.getPreOpenMarketData = function () {
     ...
     */
    NseIndia.prototype.getMergedDailyReportsCapital = function () {
     ...
     */
    NseIndia.prototype.getMergedDailyReportsDerivatives = function () {
     ...
     */
    NseIndia.prototype.getMergedDailyReportsDebt = function () {
