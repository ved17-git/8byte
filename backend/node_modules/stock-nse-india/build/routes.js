...
mainRouter.get('/api/equity/:symbol', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var symbol, data, error_12;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                symbol = req.params.symbol;
                return [4 /*yield*/, nseIndia.getEquityDetails(symbol)];
            case 1:
                data = _a.sent();
                res.json(data);
                return [3 /*break*/, 3];
...
mainRouter.get('/api/equity/intraday/:symbol', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var symbol, preOpen, data, error_17;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                symbol = req.params.symbol;
                preOpen = req.query.preOpen;
                return [4 /*yield*/, nseIndia.getEquityIntradayData(symbol, preOpen === 'true')];
            case 1:
                data = _a.sent();
                res.json(data);
                return [3 /*break*/, 3];
